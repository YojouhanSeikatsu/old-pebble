...
const devPrompt = `
You will be given a conversation where each message is formatted as "{username}: {message}". Respond appropriately to the conversation. Do not invent usernames. Reference previous messages when relevant.
`;
